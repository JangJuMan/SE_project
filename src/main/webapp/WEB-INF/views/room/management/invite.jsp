...
<div class="container">
	<div class="left-container">
		...
		<div class="menu-container">
			...
			<div>
				...
				<h4 class="specific-menu room_menu" onClick="location.href='invite'">초대하기</h4>
				<h4 class="specific-menu room_menu" onClick="location.href='authorityManagement'">권한 관리</h4>
			</div>
			<div>
	...
	<div class="right-container">
		...
		<div class="invite-area">
			<h2 class="invite-title"><strong> 초대하기 </strong></h2>
