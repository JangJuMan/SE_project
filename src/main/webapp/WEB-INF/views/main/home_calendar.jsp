	...
	<form name="calendarFrm" id="calendarFrm" action="" method="GET">
		<div class="calendar" >
			...
			<div class="navigation">
				...
				<a class="before_after_month calendar-btn" href="home.do?year=${today_info.after_year}&month=${today_info.after_month}">
				<!-- 다음달 -->
			...
			<div class="today_button_div">
				<input type="button" class="today_button" onclick="javascript:location.href='./home'" value="Today"/>
			</div>
